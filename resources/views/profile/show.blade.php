<x-app-layout>
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-12">
                <!-- Header do Perfil -->                <div class="card border-0 shadow-lg mb-4">
                    <div class="card-body p-0">                        <div class="bg-light border-bottom p-4 rounded-top">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar avatar-xl bg-primary-soft text-primary rounded-circle me-4 d-flex align-items-center justify-content-center">
                                            @if($user->role === 'tutor')
                                            ...
                                            <p class="mb-1 text-muted">
                                                @if($user->role === 'tutor')
                                                    <i class="bi bi-star-fill me-2 text-primary"></i>Tutor
                                                @elseif($user->role === 'tutorando')
                                                    <i class="bi bi-book me-2 text-primary"></i>Tutorando
                                                @else
                                                    <i class="bi bi-person me-2 text-primary"></i>{{ ucfirst($user->role) }}
                                                @endif
                                            </p>
                                            @if($user->curso)
                                                <p class="mb-0 text-muted">
                                                    <i class="bi bi-graduation-cap me-2 text-primary"></i>{{ $user->curso }}
                                                </p>
                                            @endif
                                        </div>
                                    </div>
                                                ...
                                                <div class="stat-card bg-primary-soft p-4 rounded-3">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div>
                                                            ...
                                                            @endphp
                                                            <h3 class="mb-1 text-primary fw-bold">{{ $taxa }}%</h3>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-12">
                                            ...
                                            <div class="d-flex flex-wrap gap-2">
                                                ...
                                                </a>                                                @if($user->role === 'tutor')
                                                    <a href="{{ route('publicacoes.index') }}" class="btn btn-outline-primary">
